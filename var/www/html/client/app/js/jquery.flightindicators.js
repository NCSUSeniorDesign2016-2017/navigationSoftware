...
(function($) {
	function FlightIndicator( placeholder, type, options ) {
		...
		placeholder.each(function(){
			switch(type){
				case 'heading':
					$(this).html('<div class="instrument heading"><img src="' + settings.img_directory + 'fi_box.svg" class="background box" alt="" /><div class="heading box"><img src="' + settings.img_directory + 'heading_yaw.svg" class="box" alt="" /></div><div class="mechanics box"><img src="' + settings.img_directory + 'heading_mechanics.svg" class="box" alt="" /><img src="' + settings.img_directory + 'fi_circle.svg" class="box" alt="" /></div><div class="satellite box"><img src="' + settings.img_directory + 'heading_satellite.svg" class="box" alt="" /></div></div>');
					_setHeading(settings.heading);
					_setSatellite(settings.coordinates);
				break;
				case 'variometer':
		...
		function _setSatellite(coordinates) {
			coordinates += 160;
			placeholder.each(function(){
				$(this).find('div.instrument.heading div.satellite').css('transform', 'rotate(' + -coordinates + 'deg)');
			});
		}
		...
		this.setSatellite = function(coordinates){_setSatellite(coordinates);};
